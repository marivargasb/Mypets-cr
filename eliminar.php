      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-primary">
              ...
              <button type="button" class="btn btn-danger pull-right"><i class="fa  fa-warning "></i> <a href="php\borrar\b-usuario.php?id= <?php echo $row['id_usuarios']  ?>"> ELIMINAR LA CUENTA  </a></button>
          </form>
          </div>
